    ...
    <div>
      ...
      <div className="imagee w-full md:h-[350px] h-[180px]">
        <section className="flex w-full h-full text-white items-center justify-center">
          <FaDotCircle />
          <p className="md:text-6xl text-3xl font-bold ml-5">About Us</p>
        </section>
      </div>
      ...
      <div className=" md:px-10 px-5 md:py-22">
        <div className="">
          ...
          <section className="mt-10">
            <p className="md:text-4xl text-2xl font-medium">🛡️ What Makes Us Different?</p>
            <p className="md:mt-5 mt-3 md:text-lg">
      ...
      <div className="md:px-22 px-5 pb-10 bg-[#fbf9ff]">
        <p className="md:text-5xl text-2xl text-medium pt-10">
        ...
        <div className="mt-10 grid md:grid-cols-4 gap-3">
          <section className=" flex flex-col p-5 justify-center bg-white shadow-xl h-fit md:h-[300px]">
          ...
          <section className=" flex flex-col p-5 justify-center bg-white shadow-xl md:h-[300px]">
        ...
        <section>
          ...
          <div className="md:flex justify-center">
            <div className="md:px-22 py-10 grid md:grid-cols-3 md:w-[90%] gap-10 ">
              <section className="text-center smm py-10 ">
